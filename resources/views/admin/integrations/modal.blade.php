...
<div class="modal fade text-left modal-primary" id="moveup-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel160">Move Up Menu</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                Apakah anda yakin ingin memindahkan menu tersebut!
            </div>
            <div class="modal-footer">
                <button wire:click.prevent="MoveUp()" type="button" class="btn btn-primary">Ok</button>
