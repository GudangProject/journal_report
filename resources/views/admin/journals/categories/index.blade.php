<x-master-layout>
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('posts.index') }}">List Berita</a>
                                    </li>
                                    <li class="breadcrumb-item active">List Category Berita
                                    </li>
                                </ol>
                            </div>
                        </div>
    ...
    @include('admin.posts.categories.modal-create')
