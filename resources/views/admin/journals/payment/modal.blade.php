                        ...
                        {{-- <div class="form-group">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="javascript:void(0);"wire:click='updateStatusPembayaran(1, {{ $detailPayment->id }})'>Diterima</a>
                                    <a class="dropdown-item" href="javascript:void(0);"wire:click='updateStatusPembayaran(2, {{ $detailPayment->id }})'>Menunggu</a>
                                </div>
                            </div>
                        </div> --}}
                    </div>
