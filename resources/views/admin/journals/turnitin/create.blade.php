            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h3 class="content-header-title float-left mb-0">Tambah Turnitin & Surat Pernyataan</h3>
                    ...
                    <div class="row">
                        <div class="col-12">
                            {{-- <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                <div class="alert-body"><strong>Nama hanya berisi list user/author yang sudah mengirimkan naskah</strong></div>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div> --}}
                            <div class="card">
                                <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('turnitin.store') }}">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                ...
                                                {{-- <div class="form-group">
                                                    ...
                                                    <select class="select2 form-control form-control-lg" name="user_id" required>
                                                ...
                                                <div class="form-group">
                                                    <h5 class="text-primary">Jurnal</h5>
                                                ...
                                                <div class="form-group">
                                                    <h5 class="text-primary">Link Turnitin</h5>
                                                    <input id="link" name="link_turnitin" type="url" class="form-control" placeholder="https://" value="{{ old('link_turnitin') }}" required/>
                                                    @error('link_turnitin') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                                <div class="form-group">
                                                    <h5 class="text-primary">Link Surat Pernyataan</h5>
                                                    <input id="link" name="link_surat_pernyataan" type="url" class="form-control" placeholder="https://" value="{{ old('link_surat_pernyataan') }}" required/>
