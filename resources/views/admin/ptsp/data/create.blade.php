                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{ route('services.index') }}">List Layanan</a>
                                    </li>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-8 col-12">
                                                ...
                                                <div class="form-group">
                                                    <h5 class="text-primary">URL/SLUG</h5>
                                                    <input name="slug" type="text" class="form-control" placeholder="Isi Url atau Slug" value="{{ old('slug') }}"/>
