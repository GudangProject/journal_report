    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-7 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h3 class="content-header-title float-left mb-0">Kategori Menu</h3>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/admin">Home</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('menus.index') }}">Menu</a>
                                    </li>
                                    <li class="breadcrumb-item active">List Kategori Menu
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                @endif
                @livewire('menu-category-table')
            </div>
        </div>
    </div>

    @include('admin.menus.categories.modal-create')
