            ...
            <div class="modal-content">
                <form method="POST" action="{{ route('servicecategories.store') }}">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel18">Buat Kategori Layanan</h4>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input name="name" type="text" class="form-control" placeholder="Nama Kategori Layanan" value="{{ old('name') }}" required/>
                        </div>
                        <div class="form-group">
