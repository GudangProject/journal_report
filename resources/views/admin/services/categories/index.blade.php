<x-master-layout>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-7 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h3 class="content-header-title float-left mb-0">Layanan</h3>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Home</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('services.index') }}">List Layanan</a>
                                    </li>
                                    <li class="breadcrumb-item active">List Category Layanan
                                    </li>
                                </ol>
                            </div>
                        </div>
    ...
    @include('admin.services.categories.modal-create')
