                                        ...
                                        <div class="row">
                                            <div class="col-md-8 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="title" name="title" type="text" class="form-control" placeholder="Judul Office" value="{{ old('title') }}"/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="description" type="text" class="form-control" placeholder="Alamat Website" value="{{ old('description') }}"/>
                                            ...
                                            <div class="col-md-4 col-12">
                                                ...
                                                <div class="form-group mb-2 mt-2">
                                                    ...
                                                    <input id="title" name="fkub" type="number" class="form-control" placeholder="Jumlah FKUB" value="{{ old('fkub') }}"/>
                                                ...
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input id="title" name="sekber" type="number" class="form-control" placeholder="Jumlah SEKBER" value="{{ old('sekber') }}"/>
                                                    @if ($errors->has('sekber'))<span class="text-danger">{{$errors->first('sekber')}}</span>@endif
                                                </div>
                                                <div class="form-group mb-2 mt-2">
                                                    <h5 class="text-primary">DESA SADAR KERUKUNAN</h5>
                                                    <input id="title" name="desa_sadar_kerukunan" type="number" class="form-control" placeholder="Jumlah" value="{{ old('desa_sadar_kerukunan') }}"/>
