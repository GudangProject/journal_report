    ...
    <div class="modal fade text-left" id="create-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="POST" action="{{ route('officecategories.store') }}">
                    @csrf
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel18">Buat Kategori Office</h4>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input name="name" type="text" class="form-control" placeholder="Nama Kategori Office" value="{{ old('name') }}" required/>
                        </div>
                        <div class="form-group">
