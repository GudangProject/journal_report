    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('offices.index') }}">List Office</a>
                                    </li>
                                    <li class="breadcrumb-item active">List Category Office
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                @endif
                @livewire('office-category-table')
            </div>
        </div>
    </div>

    @include('admin.offices.categories.modal-create')
