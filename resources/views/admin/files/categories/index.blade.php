    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-7 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h3 class="content-header-title float-left mb-0">File Kategori</h3>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('files.index') }}">List File</a>
                                    </li>
                                    <li class="breadcrumb-item active">List Kategori File
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                @endif
                @livewire('file-category-table')
            </div>
        </div>
    </div>

    @include('admin.files.categories.modal-create')
