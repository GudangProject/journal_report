            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-5 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h3 class="content-header-title float-left mb-0">Files</h3>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/admin">Home</a>
                                    </li>
                                    <li class="breadcrumb-item active">List Files
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="content-header-right text-md-right col-md-3 col-7">
                    <div class="form-group breadcrumb-right">
                        <a href="{{ route('files.create') }}" class="btn btn-sm btn-primary">Upload File</a>
                        <a href="{{ route('filescategories.index') }}" class="btn btn-sm btn-outline-primary">Kategori</a>
                    </div>
                </div>
            </div>
