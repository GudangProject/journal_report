            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-7 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h3 class="content-header-title float-left mb-0">Tambah Struktur Organisasi</h3>
            ...
            <div class="content-body">
                <section id="multiple-column-form">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('officers.store') }}">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-8 col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="name" name="name" type="text" class="form-control" placeholder="Nama dan Gelar jika ada" value="{{ old('name') }}"/>
...
<script type="text/javascript">
    $("#image-crop").fileinput({
        ...
        defaultPreviewContent: '<img src="{{ $data->images ?? '/assets/images/dummy-image.jpeg'}}" style="width:100%;" alt="default">',
