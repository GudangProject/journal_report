            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-5 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h3 class="content-header-title float-left mb-0">Struktur Organisasi</h3>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/admin/dashboards/dashboards">Home</a>
                                    </li>
                                    <li class="breadcrumb-item active">Struktur Organisasi
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="content-header-right text-md-right col-md-3 col-7">
                    <div class="form-group breadcrumb-right">
                        <a href="{{ route('officers.create') }}" class="btn btn-sm btn-primary">Tambah</a>
                    </div>
                </div>
            </div>
