            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-7 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h3 class="content-header-title float-left mb-0">Edit Photo</h3>
            ...
            <div class="content-body">
                <section id="multiple-column-form">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('photos-content.update', $curent->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-12">
                                                ...
                                                <div class="form-group form-group border rounded p-1">
                                                    ...
                                                    <div class="custom-file text-center">
                                                        <img name="image" src="{{ $curent->image }}" alt="users avatar" class="user-avatar users-avatar-shadow rounded my-25 cursor-pointer" width="100%" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="caption" class="form-control">{{ $curent->caption }}</textarea>
