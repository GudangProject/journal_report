    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('videos.index') }}">List Video</a>
                                    </li>
                                    <li class="breadcrumb-item active">List Category Video
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                @endif
                @livewire('video-category-table')
            </div>
        </div>
    </div>

    @include('admin.videos.categories.modal-create')
