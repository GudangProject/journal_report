                                        ...
                                        <div class="row">
                                            <div class="col-md-8 col-12">
                                                ...
                                                <div class="row col-6 form-group">
                                                    ...
                                                    <input name="published_at" type="text" class="form-control flatpickr-date-time" placeholder="Tanggal Publish Video" value="{{ old('published_at') }}" required/>
