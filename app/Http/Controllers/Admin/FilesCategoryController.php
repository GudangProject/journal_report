...
class FilesCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        try{
            ...
            return redirect()->route('filescategories.index')->with('message', "Kategori $save->name berhasil ditambahkan");
        }catch(Exception $error){
            return redirect()->route('filescategories.index')->with('message', $error->getMessage());
        }
    }
